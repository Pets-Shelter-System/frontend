...
const Hero = () => {
  return (
    <section
  className="text-center w-full  bg-cover bg-center bg-no-repeat relative overflow-hidden"
  style={{
    backgroundImage: `url(${hero1})`,
  }}
>
  <div className="relative z-10 flex flex-col justify-center items-center h-full py-24">
    {/* Title */}
