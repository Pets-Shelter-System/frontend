import heroImg from "../assets/foster2.jpg";
...
const FosterMe = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (missing) {
            Swal.fire(
                "Missing Data",
                "Please fill all required fields (Zip Code optional)",
                "warning"
            );
            return;
        }
        ...
        try {
            ...
            const res = await fetch(`${BASE_URL}/api/FosterApplications`, {
                method: "POST",
                headers: {
                    ...
                    <div className="bg-white rounded-[32px] p-8 md:p-12 shadow-[0_0_0_3px_#E7A01C]">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 text-[#011749]">
                            ...
                            <div className="pt-20 space-y-7 text-sm">
                                <h3 className="text-xl font-bold text-[#011749] mb-4">Foster Paperwork Agreement 🐾</h3>
                                ...
                                <label className="flex items-start gap-3 cursor-pointer">
                                    ...
                                    <span>
                                        ...
                                        to foster this pet or any other, and that answering further questions may
                                        be necessary. Paw Partner has the final say on any foster placement.
                                    </span>
                                </label>
                                ...
                                <label className="flex items-start gap-3 cursor-pointer">
                                    ...
                                    <span>
                                        ...
                                        of facts or omission of facts is cause for denial of foster status.
                                    </span>
                                </label>
                            </div>
