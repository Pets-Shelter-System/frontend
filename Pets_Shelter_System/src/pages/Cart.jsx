  ...
  <div className="flex items-start mt-8 gap-6">
    ...
    <tr>
      <td colSpan={5} className="text-center py-8 text-gray-500 text-lg">
        ...
        cartItems.map((item)=>{return <tr className="text-center"key={item.productId}>
...
<span>{item.productName}</span>
    ...
    <div className="w-[424px] bg-white rounded-lg p-6">
      ...
      <button className="w-[376px] text-white mt-5 px-10 py-4 bg-[#E7A01C] rounded-[44px] gap-4 text-base font-semibold leading-tight">
        Proceed to checkout
      </button>
    </div>
  </div>
